...
button.onclick = () => {
  ...
  setTimeout(() => {
    // 3초 후에 다른 페이지로 이동
    window.location.href = "http://127.0.0.1:5500/W15/FinalFroject/FinalProject02/FinalProject02.html";
  }, 3000); // 3초 (3000밀리초) 설정
};
...
nav1.onclick = () => {
  setTimeout(() => {
    // 3초 후에 다른 페이지로 이동
    window.location.href = "http://127.0.0.1:5500/W15/FinalFroject/FinalProject03.html";
  }, 2000); // 3초 (3000밀리초) 설정
};
